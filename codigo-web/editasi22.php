...
// if (($_SERVER['REMOTE_ADDR']=='192.168.100.64') OR ($_SERVER['REMOTE_ADDR']=='192.168.1.100') or ($_SERVER['REMOTE_ADDR']=='192.168.1.102')) // or ($_ENV['COMPUTERNAME']=='SERVERCAPPO'))	// permite borrar asiento
	echo "<a href='editasi22.php?asiento=$asiento&accion=boasi' onclick='return borrar_asiento()'>Borrar Asiento</a>";
/*
if ($_ENV['COMPUTERNAME']=='SERVERCAPPO')	// permite borrar asiento en el servidor
{
	echo 'este ';
	echo "<a href='editasi22.php?asiento=$asiento&accion=boasi' onclick='return borrar_asiento()'>Borrar Asiento</a>";
}
...
echo "&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;<a href='editasi22.php?asiento=$asiento&accion=altaapu'>Añadir Registro</a><p />";

echo "<form enctype='multipart/form-data' name='justificante' action='editasi22.php?asiento=$asiento' method='post'>";
