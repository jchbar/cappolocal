...
// 		bucle de listado
		...
		if ($row['renovacion']>1)
			...
			echo "</td>";
			echo "<td class='centro'>";
			if (($_SERVER['REMOTE_ADDR']=='192.168.1.9') OR ($_SERVER['REMOTE_ADDR']=='192.168.1.96') OR ($_SERVER['REMOTE_ADDR']=='192.168.1.236') or ($_ENV['COMPUTERNAME']=='JCHB-DM1'))	// icono para cancelar prestamo
