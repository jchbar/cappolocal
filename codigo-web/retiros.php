...
<?php
	...
	echo '<td>Monto</td>';
	echo '<td><input name="mdeducciones" type="text" id="mdeducciones" size="15" maxlength="15" value="0" /></td>';
	echo '</tr>';
...
//	echo '<tr><td>el monto '.$t2.'</td></tr>';
	...
	echo '<td>Monto</td>';
	echo '<td><input name="mdeducciones2" type="text" id="mdeducciones2" size="15" maxlength="15" value="'.($t2*0.02).'" /></td>';
	echo '</tr>';
