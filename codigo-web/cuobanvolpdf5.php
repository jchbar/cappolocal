...
$sql_amor="select *,descr_pres from sgcaamorvol, sgcaf360 where ('$fechadescuento' = fecha) and (proceso=1) and (codpre=cod_pres)  and sgcaf360.tipo='VOLUNTARIO' order by codpre, codsoc"; //  limit 30"; //  limit 20";
// echo $sql_amor;
