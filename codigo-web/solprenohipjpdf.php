...
//	$cuento.='  ****Bs. ('.trim(number_format($prestamo['monpre_sdp']-$prestamo['inicial'],2,".",",")).')**** en calidad de prestamo. ';
	$cuento.='  ****Bs. ('.trim(number_format(20000,2,".",",")).')**** en calidad de prestamo. ';
...
//	$cuento.='  ****Bs. ('.trim(number_format($prestamo['monpre_sdp']-$prestamo['inicial'],2,".",",")).')****. ';
	$cuento.=' por la cantidad de Bolívares VEINTE MIL ';
	$cuento.='  ****Bs. (20.000,00)****. ';
...
$pdf->SetX($columna[2]);
$pdf->Cell(60,6,number_format(2750,2,".",","),0,0,'R',0);
$t_deduccion+=2750;
...
$pdf->SetX($columna[2]);
$pdf->Cell(60,6,number_format(11000,2,".",","),0,0,'R',0);
$t_reintegro+=11000;
...
$pdf->SetFont('Arial','B',10);
$pdf->SetX($columna[0]);
$pdf->Cell(0,6,'Observacion: EMISION DE CINCO (5) GIROS ESPECIALES ANUALES Bs. 2750 C/U ',0,0,'C',0);
$pdf->SetFont('Arial','',8);
