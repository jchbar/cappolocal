...
$sqll="select * from sgcaf310 where stapre_sdp='A' order by codsoc_sdp "; //limit 10";
$resultl=mysql_query($sqll,$linkl) or die('fallo '.$sqll);

// $sqlr="delete from sgcaf310";
$sqlr="truncate table sgcaf310";
...
while($datosl=mysql_fetch_array($resultl)) {
	...
	$comando='insert into sgcaf310 values (';
	for ($i=0; $i<$campos; $i++) {
