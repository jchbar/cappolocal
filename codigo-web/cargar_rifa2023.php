...
$sql="select * from sgcaf200 where upper(statu_prof)='ACTIVO' or upper(statu_prof)='JUBILA' and (rifa_2018) order by cod_prof";
$res200=mysql_query($sql);
$dolar = 36;
$accion = 1.50;
$gasto_bancario = 1.05;
$monpre_sdp=($dolar*$accion);
$primerdcto='2023-10-25';
$lascuotas=1;
$cuota=round(($monpre_sdp*1.05),2);
...
while ($fila200 = mysql_fetch_assoc($res200))
{
	...
	$debe=$monpre_sdp;
	$totalesgral+=$debe;
	agregar_f820($asiento, $b, '+', $cuenta1, 'Prestamo Sorteo ', $debe, $haber, 0,$ip,0,$referencia,'','S',0); 
