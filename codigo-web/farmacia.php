...
*/
			...
			$cuota = 200;	// segun resolucion 19-7-2016
			$cuota = 500;	// segun resolucion 28-9-2016
...
*/
		if (($r310['cuota_ucla'] < 200))
			$cuota = 200;	// segun resolucion 10-4-2014
		if (($r310['cuota_ucla'] < 500))
			$cuota = 500;	// segun resolucion 29-92016
