...
$pdf->MultiCell(0,0,"Listado de Retención UCLA al ".convertir_fechadmy($fechaaporte),0,C,0);
$pdf->SetY($linea);
$pdf->SetFont('Arial','',8);
...
$header=array('Cédula','Apellidos y Nombres','Retención','','Cédula','Apellidos y Nombres','Retención',''); 
...
while ($row = mysql_fetch_array($result))
{
 ...
 //imprimo nombre, apellidos y localidad
	...
	$pdf->Cell($w[2+$columna],5,number_format($row['hab_prof'],2,".",",").$asterisco,0,0,'R',0);
