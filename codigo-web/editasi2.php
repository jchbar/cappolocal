...
if (($_SERVER['REMOTE_ADDR']=='192.168.100.7') OR ($_SERVER['REMOTE_ADDR']=='192.168.1.100') or ($_SERVER['REMOTE_ADDR']=='192.168.1.102')) // or ($_ENV['COMPUTERNAME']=='SERVERCAPPO'))	// permite borrar asiento
