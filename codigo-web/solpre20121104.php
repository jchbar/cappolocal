...
if ($accion == 'Buscar')  {
	...
	if ($lacedula) { //  != ' ') {
		...
		echo '<th colspan="5"></th><th width="80">A Descontar</th><th width="80">Nro.Prestamo</th><th width="280">Tipo</th><th width="100">Monto</th><th width="100">Saldo</th><th width="80">Cuota</th><th width="80">NC / CC</th></tr>';
...
if (($accion == "Editar") or ($accion=="Renovar")) {	// muestra datos para prestamo
	...
	if ($_SESSION['disponibilidadprestamo'] > 0) {
		...
		$sqlprestamos="select * from sgcaf360 where (retab_pres = 0) or (cod_pres='004') and ";
...
//		echo "<input type = 'text' value ='".$primerdcto."' name='primerdcto' id='primerdcto'>";
		$sql_acta="select * from sgcafact where especial = 1 order by fecha desc limit 4";
		$las_actas=mysql_query($sql_acta);
//		echo '111';
