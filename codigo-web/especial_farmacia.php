...
<?php
	$maximo=12500;
	$porcentaje=0.5; // 1.0; // 0.5;
	$sql="select * from sgcaf310, sgcaf200 where (tipo_socio='P') and (cod_prof=codsoc_sdp) and   (codpre_sdp='004' and stapre_sdp='A' and (renovado = 0) and ((monpre_sdp-monpag_sdp)>=".$maximo.")) order by codsoc_sdp";
...
if ($_POST['procesar']) {
	...
	//			echo $sql810;
			...
			$referencia = ($fila['monpre_sdp']-$fila['monpag_sdp']);
