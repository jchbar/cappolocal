...
$sql="select cod_prof, ced_prof, concat(trim(ape_prof),' ',nombr_prof) as nombre, ubic_prof, statu_prof from sgcaf200 where (upper(statu_prof) <> 'RETIRA') order by ".$orden; //   limit 30"; //  limit 20";
// echo $sql;
