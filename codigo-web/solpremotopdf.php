...
else
{
	...
	$cuento.=$socio['ced_prof'].' y Socio de esta institución identificado con el Código '.$socio['cod_prof'];
//	$cuento.=' me dirijo a la Junta Directiva con el fin de solicitar la cantidad de Bolívares '.strtoupper(num2letras($prestamo['monpre_sdp']-$prestamo['inicial']));
	$cuento.=' me dirijo a la Junta Directiva con el fin de solicitar la cantidad de Bolívares '.strtoupper('DIEZ MIL SEISCIENTOS OCHENTA ');
//	$cuento.='  ****Bs. ('.trim(number_format($prestamo['monpre_sdp']-$prestamo['inicial'],2,".",",")).')**** en calidad de prestamo. ';
	$cuento.='  ****Bs. ('.trim(number_format(10680,2,".",",")).')**** en calidad de prestamo. ';
...
//	$cuento.='  ****Bs. ('.trim(number_format($prestamo['monpre_sdp']-$prestamo['inicial'],2,".",",")).')****. ';
	$cuento.=' por la cantidad de Bolívares DIEZ MIL SEISCIENTOS OCHENTA ';
	$cuento.='  ****Bs. (10.680,00)****. ';
...
$pdf->Cell(60,6,number_format(10680,2,".",","),0,0,'R',0);
$linea+=5;
$pdf->SetY($linea);
$pdf->SetX($columna[0]);
...
$pdf->Cell(60,6,number_format(1780,2,".",","),0,0,'R',0);
$t_deduccion+=1780; // $prestamo['intereses'];
...
$pdf->SetX($columna[2]);
$pdf->Cell(60,6,number_format(0,2,".",","),0,0,'R',0);
$t_deduccion+=0;
...
$pdf->SetFont('Arial','B',12);
$pdf->SetX($columna[2]);
$pdf->Cell(60,6,'Neto a Descontar',0,0,'R',0);
$pdf->SetX($columna[3]);
$neto=($prestamo['monpre_sdp']-$prestamo['inicial'])+$t_reintegro-$t_deduccion;
$neto=(10680-$prestamo['inicial'])+$t_reintegro-$t_deduccion;
...
$pdf->SetFont('Arial','B',12);
$pdf->SetX($columna[0]);
$pdf->Cell(0,6,'Observacion: EMISION DE UN (01) GIRO(S) ESPECIAL(ES) ANUAL(ES) Bs. 6000 C/U ',0,0,'C',0);
$pdf->SetFont('Arial','',12);
