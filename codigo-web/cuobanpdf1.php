...
$sql_360="select * from sgcaf360 where (dcto_sem) and cod_pres!='004' order by cod_pres"; //  limit 30"; //  limit 20";
...
$sql_nopr=$condicion_sql." from sgcanopr where ('$fechadescuento' = fecha) order by cedula "; // limit 0,500";
// echo $sql_nopr;
