...
if (!$accion) {
	echo "<div id='div1'>";
	echo "<form action='depositobanco.php?accion=ListadoDeCuotas' name='form1' method='post'>";
...
//	echo $sql;
	...
	if (is_writable($nombre_archivo)) {
		...
		if (!$gestor = fopen($nombre_archivo, 'a')) {
			...
			echo "<div id='div1'>";
			echo "<form action='depositobanco.php?accion=Abonar' name='form1' method='post' onsubmit='return realizo_abono_banco(form1)'>";
...
//	echo '<input type="hidden" name="nombre_archivo" value = "'.$nombre_archivo.'"/>';
	...
	echo "<form action='depositobanco.php?accion=AsientoContable' name='form1' method='post'>";
	echo '<input type="hidden" name="fechadescuento" value="'.$fechadescuento.'">';
