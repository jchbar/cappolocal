...
$pdf->SetY($linea);
$pdf->SetX(10);
$elasiento=$_SESSION['queselleva'];
$pdf->MultiCell(0,5,$elasiento,1,'L'); 
...
//  $pdf->AddPage();
  ...
  $cuento.=trim($prestamo['nrocuotas']) ;
  $cuento.=(trim($prestamo['nrocuotas']==1)?' VEZ':' VECES').' de la(s) nómina(s) correspondientes a PAGOS ESPECIALES, que cancela la ';
...
VALUES (
'', 'SAMSUNG', '10', '1-01-03-04-06-01-0002', '480', '400', 'celular'
), (
'', 'HUAWEI', '10', '1-01-03-04-06-01-0003', '516', '430', 'celular'
);

INSERT INTO `sica`.`sgcazapa` (`item`, `modelo`, `existencia`, `cinventario`, `pvp`, `costo`, `categoria`) VALUES ('', 'MOTOROLA 109', '5', '1-01-03-04-06-01-0004', '1680', '1400', 'celular'), ('', 'MOTOROLA 201', '5', '1-01-03-04-06-01-0005', '2160', '1800', 'celular');
INSERT INTO `sica`.`sgcazapa` (`item`, `modelo`, `existencia`, `cinventario`, `pvp`, `costo`, `categoria`) VALUES ('', 'NOKIA', '5', '1-01-03-04-06-01-0006', '1680', '1400', 'celular'), ('', 'NOKIA C3', '5', '1-01-03-04-06-01-0007', '1920', '1600', 'celular');
INSERT INTO `sica`.`sgcazapa` (`item`, `modelo`, `existencia`, `cinventario`, `pvp`, `costo`, `categoria`) VALUES ('', 'SAMSUNG', '5', '1-01-03-04-06-01-0008', '1800', '1500', 'celular');
*/
?>
