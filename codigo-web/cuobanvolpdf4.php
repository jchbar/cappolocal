...
$sql_nopr=$condicion_sql." from sgcanoprvol where ('$fechadescuento' = fecha) order by cedula "; //  limit 20";
// echo $sql_nopr;
...
$sql="insert into sgcafnob (fechanom, fechagen, registros, ipgen) values ('$fechadescuento','$fechagen','$cont','$ip')";
$res=mysql_query($sql);
set_time_limit(30);
