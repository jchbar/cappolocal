...
$pdf->SetY($linea);
$pdf->SetX(0);
$sql="select codsoc_sdp, cedsoc_sdp,nom_prof, ape_prof from sgcaf310, sgcaf200 where ((tipo_socio='E' or tipo_socio='P') and (codsoc_sdp = cod_prof) and (UPPER(statu_prof)='ACTIVO' OR UPPER(statu_prof)='JUBILA')) and ((codpre_sdp='RIF' and f_1cuo_sdp='2018-12-31') and (stapre_sdp='A' or stapre_sdp='C')) order by cedsoc_sdp "; // limit 20 ";
