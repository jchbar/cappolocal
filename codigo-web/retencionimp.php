...
$pdf->MultiCell(0,0,"Listado de Retención UCLA al ".$fechaaporte,0,C,0);
$pdf->SetY($linea);
$pdf->SetFont('Arial','',8);
$pdf->SetFillColor(255,255,255);
$pdf->SetTextColor(0);
...
while ($row = mysql_fetch_array($result))
{
 ...
 //imprimo nombre, apellidos y localidad
	...
	$pdf->SetY($linea);
	$pdf->SetX(30);
	$pdf->Cell($w[0],5,$row['cod_prof'],0,0,'LRTB',0); 
	$pdf->Cell($w[1],5,$row['ced_prof'],0,0,'LRTB',0); 
	$cont++; 
    ...
    // echo $asterisco;
	$pdf->Cell($w[4],5,number_format($row['hab_prof'],2,".",",").$asterisco,0,0,'R',0);
...
$archivo='retenciones_ucla/'.$fechaaporte.'.pdf';
