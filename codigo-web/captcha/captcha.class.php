<?php
	...
	*/
	class Captcha {
		/* Variables */
		var $imageDirectory = '/path/to/your/captchaImages/directory'; // No forward slash - must be writable, chmod 777
		var $imageURL = 'http://domain.com/captchaImages/directory'; // No forward slash.
