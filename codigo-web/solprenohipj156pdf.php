...
else
{
	...
	$cuento.=$socio['ced_prof'].' y Socio de esta institución identificado con el Código '.$socio['cod_prof'];
//	$cuento.=' me dirijo a la Junta Directiva con el fin de solicitar la cantidad de Bolívares '.strtoupper(num2letras($prestamo['monpre_sdp']-$prestamo['inicial']));
	$cuento.=' me dirijo a la Junta Directiva con el fin de solicitar la cantidad de Bolívares '.strtoupper('TREINTA MIL ');
//	$cuento.='  ****Bs. ('.trim(number_format($prestamo['monpre_sdp']-$prestamo['inicial'],2,".",",")).')**** en calidad de prestamo. ';
	$cuento.='  ****Bs. ('.trim(number_format(30000,2,".",",")).')**** en calidad de prestamo. ';
...
//	$cuento.='  ****Bs. ('.trim(number_format($prestamo['monpre_sdp']-$prestamo['inicial'],2,".",",")).')****. ';
	$cuento.=' por la cantidad de Bolívares TREINTA MIL ';
	$cuento.='  ****Bs. (30.000,00)****. ';
...
$pdf->SetX($columna[2]);
$pdf->Cell(60,6,number_format(2250,2,".",","),0,0,'R',0);
$t_deduccion+=2250;
...
$pdf->SetX($columna[2]);
$pdf->Cell(60,6,number_format(18000,2,".",","),0,0,'R',0);
$t_reintegro+=18000;
...
$pdf->SetFont('Arial','B',10);
$pdf->SetX($columna[0]);
$pdf->Cell(0,6,'Observacion: EMISION DE TRES (3) GIROS ESPECIALES ANUALES Bs. 6750 C/U ',0,0,'C',0);
$pdf->SetFont('Arial','',8);
