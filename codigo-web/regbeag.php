...
/*
	...
	echo "<tr><th>Cédula</th><th>Titular</th></tr>\n";

	echo "<tr><td>\n";

	echo "<input type = 'text' value ='$cedula' size='11' maxlength='11' name='cedula' readonly='readonly' onfocus='form1.fecha.focus()' tabindex='1'>";
	echo "</td><td>\n";
...
<input type = 'submit'name = 'formu' value = 'Añadir' tabindex='10' onclick='return compruebabeneficiario(form1)'>
