...
$pdf->MultiCell(0,0,"Listado de Ahorro Voluntario al ".convertir_fechadmy($fechaaporte),0,C,0);
$pdf->SetY($linea);
$pdf->SetFont('Arial','',8);
...
$header=array('Cédula','Apellidos y Nombres','Voluntario','','Cédula','Apellidos y Nombres','Voluntario',''); 
...
$archivo='ahorro_voluntario/'.$fechaaporte.'.pdf';
