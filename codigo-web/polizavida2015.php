...
while ($fila200 = mysql_fetch_assoc($resultado))
{
	...
	$totalesgral+=$debe;
	agregar_f820($asiento, $b, '+', $cuenta1, 'Poliza Vida 2015-2016', $debe, $haber, 0,$ip,0,$referencia,'','S',0); 
}
$debe=$totalesgral;
$cuenta1='1-01-02-05-02-01-0008';
agregar_f820($asiento, $b, '-', $cuenta1, 'Poliza 2015-2016', $debe, $haber, 0,$ip,0,$referencia,'','S',0); 
