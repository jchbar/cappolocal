...
//			echo $sql_360;
			if ($estatutarios == 'on')
			{
				...
				$sql_360="select * from sgcaf360 where (dcto_sem = 1) and (cod_pres <> '032' and cod_pres <> '055' and cod_pres <> '064' and cod_pres <> '066' and cod_pres <> '067' and cod_pres <> '068' and cod_pres <> '072' and cod_pres <> '065') order by cod_pres";
